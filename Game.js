class Game {
    ...
    render(colors = ['gray', 'gray', 'gray'], money = this.wallet.getWalletValue(),result = "", stats = [0,0,0], wonMoney, bid) {
    ...
    startGame() {
        ...
        if(this.wallet.checkCanPlay(bid)) {
            return alert("masz za mało środków lub podana zostala nieprawidlowa wartosc")
        }
        ...
        const wonMoney = Result.moneyWinInGames(win, bid);
